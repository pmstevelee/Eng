    ...
    <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto">
          <ScrollReveal>
            <div className="text-center mb-14">
              <h2 className="text-4xl font-bold text-gray-900 mb-3">5개 영역 독립 측정</h2>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal>
            <div className="text-center mb-14">
              <h2 className="text-4xl font-bold text-gray-900 mb-3">CEFR 기반 10단계 레벨 체계</h2>
              <p className="text-gray-500 max-w-xl mx-auto">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal>
            <div className="text-center mb-14">
              <h2 className="text-4xl font-bold text-gray-900 mb-3">테스트 진행 프로세스</h2>
              <p className="text-gray-500 max-w-xl mx-auto">
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <ScrollReveal>
            <div className="text-center mb-14">
              <h2 className="text-4xl font-bold text-gray-900 mb-3">전통 시험과 무엇이 다른가요?</h2>
              <p className="text-gray-500 max-w-xl mx-auto">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-6">
                  <div className="flex items-center justify-between mb-5">
                    ...
                    <div className="bg-primary-50 text-primary-700 text-xs font-bold px-3 py-2 rounded-lg">
                      PDF 출력
                    </div>
                  </div>
                  ...
                  <div className="rounded-xl bg-gray-50 p-4">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-14 text-sm text-gray-600">가장 강한 영역</div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-14 text-sm text-gray-600">집중 필요 영역</div>
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      <div key={cond.label} className="flex items-start gap-3">
                        <span className={`font-bold flex-shrink-0 mt-0.5 ${cond.done ? 'text-accent-green' : 'text-gray-300'}`}>
                          {cond.done ? '✓' : '○'}
                        </span>
                        <div>
