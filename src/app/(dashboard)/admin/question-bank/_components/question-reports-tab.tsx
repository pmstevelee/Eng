...
import { Flag, CheckCircle, XCircle, ChevronDown, ChevronUp } from 'lucide-react'
...
export default function QuestionReportsTab({ reports, onEditQuestion, onDeleteQuestion }: Props) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <h2 className="text-base font-semibold text-gray-900">문제 오류 신고</h2>
          {pendingCount > 0 && (
                            ...
                            <div className="flex items-start gap-3 pt-1">
                              <div className="flex-1">
                                <textarea
                                  ...
                                  rows={2}
                                  className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm resize-none outline-none focus:border-[#1865F2]"
                                />
                              </div>
                              <div className="flex flex-col gap-2 shrink-0">
                                <button
                                  onClick={() => onEditQuestion(report.questionId)}
                                  className="rounded-lg border border-[#1865F2] px-4 py-2 text-xs font-semibold text-[#1865F2] hover:bg-blue-50"
                                >
                                  문제 수정
                                </button>
                                <button
                                  onClick={() => onDeleteQuestion(report.questionId)}
                                  className="rounded-lg border border-[#D92916] px-4 py-2 text-xs font-semibold text-[#D92916] hover:bg-red-50"
                                >
                                  문제 삭제
                                </button>
                                <button
