...
import { createOwnerWordTestAssignment } from '@/app/(dashboard)/owner/words/_actions/test'
...
export function NewOwnerWordTestForm({ setId, setTitle, wordCount, classes }: Props) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await createOwnerWordTestAssignment({
        setId,
        title: title.trim(),
      ...
      router.push(`/owner/words/sets/${setId}/test/${result.id}/results`)
    })
  }
