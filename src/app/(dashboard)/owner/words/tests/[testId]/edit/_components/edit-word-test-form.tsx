...
import { updateOwnerWordTestAssignment } from '../../../../_actions/test'
...
interface Props {
  ...
  initialTitle: string
  initialMode: string
  initialTimePerQuestion: string
  initialNumQuestions: string
...
export function EditOwnerWordTestForm({
  testId,
  wordCount,
  classes,
  initialTitle,
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await updateOwnerWordTestAssignment(testId, {
        title: title.trim(),
