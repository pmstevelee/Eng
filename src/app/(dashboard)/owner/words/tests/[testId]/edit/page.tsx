...
import { getClassesForOwner } from '../../../_actions/test'
import { EditOwnerWordTestForm } from './_components/edit-word-test-form'
...
export default async function OwnerWordTestEditPage({ params }: Props) {
  ...
  if (!assignment) redirect('/owner/words/tests')
