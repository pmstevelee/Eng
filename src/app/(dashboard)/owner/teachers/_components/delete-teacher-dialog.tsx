...
type TeacherToDelete = { id: string; name: string }
    ...
    >
      <div className="bg-white rounded-2xl w-full max-w-sm mx-4 shadow-lg">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">교사 탈퇴 처리</h2>
          <button
            onClick={onClose}
            disabled={isPending}
          ...
          <div className="flex items-start gap-3 p-4 bg-red-50 rounded-xl border border-red-100">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-600">
                <span className="font-semibold text-gray-900">{teacher.name}</span> 교사의 모든 데이터가 영구 삭제됩니다.
              </p>
