...
export default function StudentsListClient({
  ...
  const activeTab =
    initialClassId === 'unassigned' ? 'unassigned' : initialStatus
            ...
            <tbody className="divide-y divide-gray-100">
              {students.map((student) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`inline-flex items-center text-xs font-medium px-2.5 py-0.5 rounded-full ${STATUS_COLOR[student.status]}`}
                    >
