...
import { updateWordTestAssignment } from '../../../../actions'
...
export function EditWordTestForm({
  testId,
  wordCount,
  classes,
  initialTitle,
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await updateWordTestAssignment(testId, {
        title: title.trim(),
      ...
      router.push('/teacher/words/tests')
      router.refresh()
    })
  }
