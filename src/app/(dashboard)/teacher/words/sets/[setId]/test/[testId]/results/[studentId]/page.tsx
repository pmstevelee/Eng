...
export default async function TeacherWordTestStudentResultPage({ params }: Props) {
  ...
  if (!attempt || attempt.assignment.teacherId !== user.id) {
    redirect(`/teacher/words/sets/${setId}/test/${testId}/results`)
  }
  ...
  return (
    <div className="max-w-md mx-auto space-y-6">
      <Link
        href={`/teacher/words/sets/${setId}/test/${testId}/results`}
