...
import type { RegisterTeacherData } from './actions'
...
export default function RegisterTeacherPage() {
  ...
  const handleSubmit = () => {
    ...
    const data: RegisterTeacherData = {
      name, email, password, phone, academyId,
    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/50 p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          <h1 className="text-2xl font-bold tracking-tight">교사 가입</h1>
          ...
          {step === 2 && (
            <>
              <CardHeader>
                ...
                <CardDescription>
                  <span className="font-medium text-foreground">{academyName}</span>에 교사로 가입합니다
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
          ...
          {step === 3 && (
            <>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Button variant="outline" className="flex-1" onClick={() => goPrev(2)} disabled={isPending}>
                    이전
                  </Button>
