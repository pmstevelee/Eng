    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900">IVY LMS</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => { setShowForgot(!showForgot); setForgotMessage(null) }}
        ...
        <p className="text-center text-sm text-gray-500">
          계정이 없으신가요?{' '}
          <Link href="/register" className="font-medium text-primary-700 hover:text-primary-600 transition-colors">
            회원가입
          </Link>
        </p>
      </div>
