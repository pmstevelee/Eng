...
const SOURCE_LABEL = '출처: 2026학년도 제1회 전국 13개 시·도교육청 공동 주관 영어듣기능력평가(고3) — 2026.4.9.(목) 시행'
...
const LISTENING_QUESTIONS: ListeningQuestion[] = [
  // ── 1번: 적절한 응답 (대화 완성) ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 4,
      explanation:
        '엄마가 출장에서 돌아오는 날 같은 요리를 해주겠다는 아빠의 말에 "좋은 생각이야, 엄마한테 멋진 깜짝선물이 될 거야"가 가장 적절합니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 2번: 적절한 응답 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 1,
      explanation:
        '도서관에 가는 길에 책을 반납해달라는 부탁에 "물론이지, 책만 줘"가 가장 적절합니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 3번: 적절한 응답 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 2,
      explanation:
        '온라인으로 등록할 수 있고 링크를 보내주겠다는 말에 "고마워, 바로 등록할게"가 가장 적절합니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 4번: 주제 파악 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 5,
      explanation:
        '성공한 예술가들의 공통적 특징(세밀한 관찰력, 새로운 시도에 대한 개방성 등)에 대해 이야기하고 있습니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 5번: 목적 파악 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 3,
      explanation:
        '교내 촬영 및 SNS 공유 시 허가를 받아야 한다는 새로운 규정을 공지하는 것이 목적입니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 6번: 주장 파악 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 1,
      explanation:
        '여자는 아이의 집중력을 키우기 위해 일기 쓰기를 시켜야 한다고 주장하고 있습니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 7번: 의견 파악 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 5,
      explanation:
        '남자는 수건을 말아 목 아래에 받치고 자면 목 통증이 완화된다고 말하고 있습니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 8번: 관계 파악 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 2,
      explanation:
        '여자는 잡지 기사를 쓰기 위해 인터뷰를 하고 있고, 남자는 체스 세계 챔피언입니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 9번: 그림 상황 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 4,
      explanation:
        '그림에서 남자가 그림을 거꾸로 들고 있는 상황으로, 여자가 그림이 거꾸로라고 알려주는 4번이 적절합니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 10번: 부탁한 일 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 1,
      explanation:
        '여자는 남자에게 체육관 벽에 현수막을 걸어달라고 부탁했습니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 11번: 이유 파악 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 4,
      explanation:
        '남자는 몇 년간 쉬지 않고 일해서 재충전의 시간이 필요하다고 말했습니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 12번: 금액 계산 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 2,
      explanation:
        '간식 2봉지 $30 + 덴탈 츄 4개 $20 = $50, 회원카드 10% 할인 → $50 × 0.9 = $45\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 13번: 언급되지 않은 것 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 5,
      explanation:
        '소요 시간(45분), 참가 연령(18세 이상), 비용($35), 예약 방법(공식 앱)은 언급되었지만, 최대 이용 인원은 언급되지 않았습니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 14번: 내용 일치/불일치 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 5,
      explanation:
        "대본에 \"There's no participation fee\"라고 했으므로 참가비가 없습니다. ⑤가 일치하지 않습니다.\n\n" +
        SOURCE_LABEL,
    },
  },
  // ── 15번: 표 보고 선택 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 1,
      explanation:
        'Leather 제외(D), Cloud 모양 제외(E), White 제외(C) → A($12)와 B($18) 중 더 저렴한 A를 선택합니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 16번: 적절한 응답 (긴 대화) ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 3,
      explanation:
        '600달러에서 550달러로 할인해주겠다는 제안에 "감사합니다, 좋은 거래네요"가 가장 적절합니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 17번: 적절한 응답 (긴 대화) ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 3,
      explanation:
        '파일이 노트북에 준비되어 있다는 말에 "그럼 늦기 전에 빨리 업로드해"가 가장 적절합니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 18번: 상황 설명 후 적절한 말 ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 5,
      explanation:
        'Scott은 Hana에게 청소 작업이 동물의 건강을 유지하는 데 필수적이라고 말하고 싶으므로 ⑤가 적절합니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 19번: 주제 파악 (긴 담화) ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 4,
      explanation:
        '우주 기술에서 유래한 일상용품(선글라스, 무선 청소기, 노트북, 연기 감지기)에 대해 이야기하고 있습니다.\n\n' +
        SOURCE_LABEL,
    },
  },
  // ── 20번: 언급되지 않은 것 (19번과 동일 담화) ──
  {
    ...
    contentJson: {
      ...
      correctAnswer: 4,
      explanation:
        '선글라스, 무선 청소기, 노트북, 연기 감지기는 언급되었지만, 정수기(water purifiers)는 언급되지 않았습니다.\n\n' +
        SOURCE_LABEL,
    },
  },
]
