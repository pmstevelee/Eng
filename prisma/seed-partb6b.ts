/**
 * prisma/seed-partb6b.ts
 * Book 1 - Part B 공용 문제 시드 (Clauses - 중급/고급 Part 2)
 *
 * 출처: partb-1.pdf
 * - B6b: Intermediate / Upper-Intermediate, 절 (부사절·접속사·시제) Q159-280 (122문제)
 *
 * 모두 공용 문제(academyId=null)로 등록.
 *
 * 실행: npm run seed:partb6b
 */
...
const SECTION_META: SectionMeta[] = [
  {
    id: 'B6b',
    domain: 'GRAMMAR',
    subCategory: '절·접속사 (중급) - 부사절·시제·조건절',
    cefrLevel: 'B1 상',
    difficulty: 7,
    sourceTag: 'partb6b',
  },
...
async function main() {
  console.log('📚 Part B6b 공용 문제 시드 시작...\n')

  const dataPath = path.join(__dirname, 'data-partb6b.json')
